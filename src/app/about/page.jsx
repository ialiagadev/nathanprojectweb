  ...
  return (
    <div className={`${raleway.className} min-h-screen p-8 relative overflow-hidden`}>
      ...
      <div className="relative z-10 max-w-6xl mx-auto text-white">
        <h1 className={`${raleway.className} text-4xl sm:text-5xl md:text-6xl font-extralight mb-8 text-center`}>
...
const InfoCard = ({ title, content }) => (
  <div className="bg-white/10 p-6 rounded-lg backdrop-filter backdrop-blur-lg">
...
const ServiceCard = ({ service }) => (
  <div className="bg-white/10 p-6 rounded-lg backdrop-filter backdrop-blur-lg text-center">
